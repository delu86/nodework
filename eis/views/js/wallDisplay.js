...
WallDisplay.prototype.setUpFooterCard = function (service) {
	...
	$("#footer"+service.nomeservizio).append("<a href='/getInfo/"+this.abi
				+"/"+service.nomeservizio+"/"+this.date+
				"'><img class='tables_link' src='img/tables.png' /></a><h4 class='logtime' id='logtime"
				+service.nomeservizio+"'></h4>");
};
